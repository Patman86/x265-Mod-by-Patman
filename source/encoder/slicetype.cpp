...
void LookaheadTLD::calcFrameSegment(Frame *preFrame)
{
    ...
    if (edgeIntensity < FRAME_EDGE_THRESHOLD)
        preFrame->m_autoAq = brightnessIntensity > FRAME_BRIGHTNESS_THRESHOLD ? X265_AQ_AUTO_VARIANCE : X265_AQ_AUTO_VARIANCE_BIASED;
    else
        preFrame->m_autoAq = brightnessIntensity > FRAME_BRIGHTNESS_THRESHOLD ? X265_AQ_EDGE : X265_AQ_VARIANCE;
